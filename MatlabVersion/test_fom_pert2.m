...
for i = 1:NN
    ...
    fom_val1(i) = (y(end,4:6))*init_cond1(4:6) - ...
        (y(end,1:3))*init_cond1(7:9) - ...
        (y(end,7:9))*init_cond1(1:3) - ...
        (y(end,10))*init_cond1(10);
...
for i = 1:NN
    ...
    % left side of fom integration equation
    % left side of fom integration equation
    fom_val2(i) = (y(end,4:6))*init_cond1(4:6) - ...
        (y(end,1:3))*init_cond1(7:9) - ...
        (y(end,7:9))*init_cond1(1:3) - ...
        (y(end,10))*init_cond1(10);
...
for i = 1:NN
    ...
    [y] = ode3(@(t,Y) odefcn(t,Y,params), z_interval(1), h, z_interval(2), init_cond);
        ...
        % left side of fom integration equation
    % left side of fom integration equation
    fom_val3(i) = (y(end,4:6))*init_cond1(4:6) - ...
        (y(end,1:3))*init_cond1(7:9) - ...
        (y(end,7:9))*init_cond1(1:3) - ...
        (y(end,10))*init_cond1(10);
...
for i = 1:NN
    ...
    [y] = ode3(@(t,Y) odefcn(t,Y,params), z_interval(1), h, z_interval(2), init_cond);
            ...
            % left side of fom integration equation
    % left side of fom integration equation
    fom_val4(i) = (y(end,4:6))*init_cond1(4:6) - ...
        (y(end,1:3))*init_cond1(7:9) - ...
        (y(end,7:9))*init_cond1(1:3) - ...
        (y(end,10))*init_cond1(10);
...
plot(fom_int1+oset); plot(fom_val1); title('Solenoid strength'); legend('Integral','direct measurement');

subplot(2,2,2); hold on;
plot(fom_int2+oset); plot(fom_val2); title('quad 1 strength');

subplot(2,2,3); hold on;
plot(fom_int3+oset); plot(fom_val3); title('quad 2 strength');

subplot(2,2,4); hold on;
plot(fom_int4+oset); plot(fom_val4); title('quad 3 strength');
